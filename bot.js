...
const fetch = require('node-fetch'); // если Node.js < 18, иначе можно убрать
...
📄 **Administrator:** <@${adminId}>`;
    ...
    if (interaction.commandName === 'unban') {
        ...
        await sendLog("UNBAN LOG", displayName, userId, `${base}`, avatar);
    ...
    if (interaction.commandName === 'banlist') {
        ...
        const text = data.map(b => `${b.username} (${b.userId}) — ${b.daysLeft} day(s)`).join("\n");
